...
import styles from "./mobileClansTable.module.scss";
...
interface MobileClansTable {}

const MobileClansTable: FC<MobileClansTable> = () => {
          ...
          <div className={styles["table-content"]}>
            {players?.map((data, index) => (
              ...
              >
                ...
                <div className={styles["user-name"]}>{data.clanName}</div>
                <div
...
export default MobileClansTable;
